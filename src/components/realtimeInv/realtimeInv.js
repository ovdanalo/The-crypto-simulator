    ...
    return (
        ...
        >
                    ...
                    <div>
                        <div className='flex justify-between'>
                            <div className='flex flex-col items-start justify-end p-3 w-max rounded-lg text-teal-50'>
                                <div
                                    className={`${isDarkTheme ? "text-white" : "text-black-100"} md:text-lg`}
                                >
                                    Total Invested:
                                    {totalInvested.toFixed(2)}€ / {parseFloat(totalInvestedUsd).toFixed(2)}$
                                </div>
                                <div className={`${isDarkTheme ? "text-white" : "text-black-100"} md:text-lg`}>
                        ...
                        <form>
                            <div>
                                ...
                                <select
                                    id='money'
                                    onChange={(event) => setCurrency(event.target.value)}
                                    className={`rounded-tr-lg rounded-br-lg p-1  shadow focus:outline-none focus:ring-2 focus:border-transparent ${isDarkTheme ? "bg-teal-100 focus:ring-teal-300 " : ""
                                        }`}
                                >
                                    <option>EUR</option>
                                    <option>USD</option>
            ...
            {!!showSell && (
                <div>
                    <div
                        className={`top-14 right-18 p-10 self-center flex-col  w-65 rounded-lg z-10 border-solid border-2  absolute ${isDarkTheme
                    ...
                    >
                        <label
                            ...
                            className={` font-bold mb-4 ${isDarkTheme ? "text-white" : "text-black-100"
                                }`}
                        >
