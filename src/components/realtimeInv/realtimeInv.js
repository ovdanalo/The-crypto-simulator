...
const Realtime = ({ data }) => {
  ...
  return (
    <div
      className={`flex flex-row  w-full md:w-10/12 xl:w-8/12 h-def mx-auto my-6 justify-center rounded-lg ${
        isDarkTheme ? "bg-black-200" : "bg-white-mode-300"
      }`}
    >
      <div
        className={`xl:flex flex-col bg-black-100 w-1/3 m-6 mr-0 rounded-lg py-12 hidden ${
          isDarkTheme ? "bg-black-100" : "bg-white-mode-200"
        }`}
      >
        <form>
          <div>
            ...
            <div className='flex justify-center'>
              <input
                ...
                id='inputAmount'
                type='number'
                className={`rounded-tl-lg rounded-bl-lg text-center p-1  shadow focus:outline-none focus:ring-2  focus:border-transparent ${
                  isDarkTheme
              ...
              <select
                ...
                className={`rounded-tr-lg rounded-br-lg justify-center p-1  shadow ${
                  isDarkTheme ? "bg-teal-100" : "bg-white-mode-100"
                }`}
              >
                <option>EUR</option>
                <option>USD</option>
          ...
          <div>
            <label
              for='crypto'
              className={`flex pt-12 pb-6 justify-center ${
                isDarkTheme ? "text-white" : "text-black-100"
              }`}
            >
      ...
      <div
        className={`flex flex-col w-full xl:w-2/3 m-6 rounded-lg ${
          isDarkTheme ? "bg-black-100" : "bg-white-mode-200"
        }`}
      >
          ...
          <div>
            <div className='flex justify-between'>
              <div className='flex flex-col items-start justify-end p-3 w-max rounded-lg text-teal-50'>
                ...
                >
                  You Now Have:{totalEuro}£/{parseFloat(totalUsd).toFixed(2)}$
                </div>
                <div
                  className={`${
        ...
        {showAdd && (
          <div
            className={`mt-10 p-10 self-center flex-col  w-65 rounded-lg xl:hidden z-10 border-solid border-2  absolute ${
              isDarkTheme
            ...
            <form>
              <div>
                ...
                <select
                  id='money'
                  onChange={(event) => setCurrency(event.target.value)}
                  className={`rounded-tr-lg rounded-br-lg p-1  shadow focus:outline-none focus:ring-2 focus:border-transparent ${
                    isDarkTheme ? "bg-teal-100 focus:ring-teal-300 " : ""
                  }`}
                >
                  <option>EUR</option>
                  <option>USD</option>
              ...
              <div>
                ...
                <input
                  ...
                  size='27'
                  autocomplete='off'
                  className={`rounded-lg p-1  shadow focus:outline-none focus:ring-2  focus:border-transparent ${
                    isDarkTheme
      ...
      {!!showSell && (
        <div>
          <div
            className={`top-14 right-18 p-10 self-center flex-col  w-65 rounded-lg z-10 border-solid border-2  absolute ${
              isDarkTheme
                ? "bg-black-200 border-teal-200"
                : "bg-white-mode-300 border-black-400"
            }`}
          >
            <label
              htmlFor='toSellCryptoAmount'
            ...
            <div className='flex flex-col items-center sm:flex-row sm:items-center'>
              <input
                ...
                className={`w-full rounded-md py-2 px-3  m-4 text-gray-800 font-medium focus:outline-none focus:ring-2 focus:border-transparent ${
                  isDarkTheme
                    ? "bg-teal-100 focus:ring-teal-300"
                    : "bg-white-mode-100 focus:ring-black-100"
                }`}
