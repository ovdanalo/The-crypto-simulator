                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <h3 className="text-teal-100 text-xl m-6">Who Are The Founders Of Tether?</h3>
                                <p class="text-white px-1 md:px-15">USDT — or as it was known at the time, Realcoin — was launched in 2014 by Brock Pierce, Reeve Collins and Craig Sellars.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">What Makes Tether Unique?</h3>
                                <p class="text-white px-1 md:px-15">USDT’s unique feature is the fact that its value is guaranteed by Tether to remain pegged to the U.S. dollar. According to Tether, whenever it issues new USDT tokens, it allocates the same amount of USD to its reserves, thus ensuring that USDT is fully backed by cash and cash equivalents.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How Many Tether (USDT) Coins Are There In Circulation?</h3>
                                <p class="text-white px-1 md:px-15">There is no hard-coded limit on the total supply of USDT — given the fact that it belongs to a private company, theoretically, its issuance is limited only by Tether’s own policies. However, because Tether claims that every single USDT is supposed to be backed by one U.S. dollar, the amount of tokens is limited by the company’s actual cash reserves.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How Is the Tether Network Secured?</h3>
                                <p class="text-white px-1 md:px-15">USDT does not have its own blockchain — instead, it operates as a second-layer token on top of other cryptocurrencies’ blockchains: Bitcoin, Ethereum, EOS, Tron, Algorand, Bitcoin Cash and OMG, and is secured by their respective hashing algorithms.</p>
                            </div>
                        </div>
                    );
                }
