                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How is the OKB Network protected?</h3>
                                <p class="text-white px-1 md:px-15">The coin is an ERC-20 token based on proof-of-stake (PoS) consensus. OKB originally operated on the Ethereum blockchain, but the company later transitioned to its own blockchain: OKExChain.
