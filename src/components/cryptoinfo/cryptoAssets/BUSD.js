                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p class="text-white px-1 md:px-15">In light of the TerraUSD saga, a number of stablecoin issuers have moved to disclose the assets backing their coins. As of June 30, 2022, 96% of the assets backing the Binance USD were held in cash and cash equivalents, while 4% were invested in U.S. Treasury bills, Paxos revealed.
                                ...
                                <p class="text-white px-1 md:px-15">In April 2022, Binance donated $2.5 million in BUSD through its charity organization to USA for UNHCR, a UN refugee agency. This was the agency’s first stablecoin crypto donation. The move demonstrated how cryptocurrency can play a key role in raising funds and supporting humanitarian aid.</p>
                            </div>
                        </div>
                    );
                }
