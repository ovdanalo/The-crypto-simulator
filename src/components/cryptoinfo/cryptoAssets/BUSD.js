...
const BUSD = (props) => {
    ...
    return (
        <div className={`flex flex-col p-4 ${isDarkTheme ? "bg-black-100" : "bg-white-mode-100"}`}>
                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p class={` px-1 md:px-15 ${isDarkTheme ? "text-white" : "text-black-100"}`}>Binance USD (BUSD) is a 1:1 USD-backed stable coin issued by Binance (in partnership with Paxos), Approved and regulated by the New York State Department of Financial Services (NYDFS), The BUSD Monthly Audit Report can be viewed from the official website. Launched on 5 Sep 2019, BUSD aims to meld the stability of the dollar with blockchain technology. It is a digital fiat currency, issued as ERC-20 and supports BEP-2.</p>
                                <h3 className={`text-xl m-6 ${isDarkTheme ? "text-teal-100 " : "text-black-100"}`}>BUSD Use Case</h3>
                                <p class={` px-1 md:px-15 ${isDarkTheme ? "text-white" : "text-black-100"}`}>Based on the price stability, Stablecoin plays an important role in transactions, payments and settlement, and Decentralised Finance (DeFi).
                                ...
                                <h3 className={`text-xl m-6 ${isDarkTheme ? "text-teal-100 " : "text-black-100"}`}>Paxos Reveals Assets Backing BUSD</h3>
                                <p class={` px-1 md:px-15 ${isDarkTheme ? "text-white" : "text-black-100"}`}>In light of the TerraUSD saga, a number of stablecoin issuers have moved to disclose the assets backing their coins. As of June 30, 2022, 96% of the assets backing the Binance USD were held in cash and cash equivalents, while 4% were invested in U.S. Treasury bills, Paxos revealed.
                                ...
                                <h3 className={`text-xl m-6 ${isDarkTheme ? "text-teal-100 " : "text-black-100"}`}>BUSD and Charity</h3>
                                <p class={` px-1 md:px-15 ${isDarkTheme ? "text-white" : "text-black-100"}`}>In April 2022, Binance donated $2.5 million in BUSD through its charity organization to USA for UNHCR, a UN refugee agency. This was the agency’s first stablecoin crypto donation. The move demonstrated how cryptocurrency can play a key role in raising funds and supporting humanitarian aid.</p>
                            </div>
                        </div>
                    );
                }
