                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p class="text-white px-1 md:px-15">Cardano is a proof-of-stake blockchain platform that says its goal is to allow “changemakers, innovators and visionaries” to bring about positive global change.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">Who Are the Founders of Cardano?</h3>
                                <p class="text-white px-1 md:px-15">Cardano was founded by Charles Hoskinson, who was also one of the co-founders of the Ethereum network. He is the CEO of IOHK, the company that built Cardano’s blockchain.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">What Makes Cardano Unique?</h3>
                                <p class="text-white px-1 md:px-15">Cardano is one of the biggest blockchains to successfully use a proof-of-stake consensus mechanism, which is less energy intensive than the proof-of-work algorithm relied upon by Bitcoin. Although the much larger Ethereum is going to be upgrading to PoS, this transition is only going to take place gradually.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">What Is Cardano’s Vasil Hard Fork?</h3>
                                <p class="text-white px-1 md:px-15">Named after late Bulgarian mathematician Vasil Dabov, a prominent contributor to Cardano, the Vasil hard fork is touted as one of the most highly-anticipated upgrades for Cardano. The hard fork is the third development epoch of Cardano and is supposed to introduce several upgrades to the blockchain’s smart contract programming language Plutus and the network’s capacity.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How Is the Cardano Network Secured?</h3>
                                <p class="text-white px-1 md:px-15">Cardano is secured through an “environmentally sustainable, verifiably secure” PoS protocol that’s known as Ouroboros.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">What Is Cardano’s Alonzo Upgrade?</h3>
                                <p class="text-white px-1 md:px-15">On Sept. 12, Cardano released its highly-anticipated Alonzo upgrade. Following the upgrade, the blockchain network can now support a wide range of crypto applications, including non-fungible tokens (NFTs) and smart contracts.
