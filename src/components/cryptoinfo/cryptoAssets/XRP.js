                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p class="text-white px-1 md:px-15">Launched in 2021, the XRP Ledger (XRPL) is an open-source, permissionless and decentralized technology. Benefits of the XRP Ledger include its low-cost ($0.0002 to transact), speed (settling transactions in 3-5 seconds), scalability (1,500 transactions per second) and inherently green attributes (carbon-neutral and energy-efficient). The XRP Ledger also features the first decentralized exchange (DEX) and custom tokenization capabilities built into the protocol. Since 2012, the XRP Ledger has been operating reliably, having closed 70 million ledgers.</p>
                                <h3 className="text-teal-100 text-xl m-6">Who Are the Founders of the XRP Ledger?</h3>
                                <p class="text-white px-1 md:px-15">In 2012, David Schwartz, Jed McCaleb and Arthur Britto launched the XRP Ledger with its native currency XRP as a faster, more energy-efficient alternative to the Bitcoin blockchain. In September that year, along with Chris Larsen, they founded the company that is today known as Ripple.</p>
                                <h3 className="text-teal-100 text-xl m-6">What Makes XRPL Unique?</h3>
                                <p class="text-white px-1 md:px-15">The XRP Ledger presents a wide variety of applications and use cases related to payments including micropayments, DeFi, and, soon, NFTs. Deployed in 2012, the XRPL supports enterprises and Python, Java and JavaScript developers with powerful utility and flexibility. On the XRP website, developers can access different tutorials to help them get started using different coding languages, building apps, managing accounts and more.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">Ripple and the SEC</h3>
                                <p class="text-white px-1 md:px-15">Since late 2020, Ripple Labs, the creators of the XRP token, has been locked in a legal battle with the United States Securities and Exchange Commission. The big question is whether or not XRP is a security.
