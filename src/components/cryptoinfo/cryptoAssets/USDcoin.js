                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p class="text-white px-1 md:px-15">USD Coin (known by its ticker USDC) is a stablecoin that is pegged to the U.S. dollar on a 1:1 basis. Every unit of this cryptocurrency in circulation is backed up by $1 that is held in reserve, in a mix of cash and short-term U.S. Treasury bonds. The Centre consortium, which is behind this asset, says USDC is issued by regulated financial institutions.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">Who Are the Founders of USD Coin?</h3>
                                <p class="text-white px-1 md:px-15">The Centre Consortium has two founding members. One of them is the peer-to-peer payment services company Circle, while the other is the Coinbase cryptocurrency exchange. Other crypto ventures are open to join this consortium.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">What Makes USD Coin (USDC) Unique?</h3>
                                <p class="text-white px-1 md:px-15">The stablecoin market has become exceedingly crowded over recent years — but USD Coin has aimed to stand head and shoulders over competitors in several ways.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How Much Is Held in USD Coin Asset Reserves?</h3>
                                <p class="text-white px-1 md:px-15">Following the collapse of TerraUSD, stablecoin issuers have been under intense scrutiny over the quality of the reserves backing their tokens. In a transparency move, Circle Internet Financial LLC (Circle), the issuer of the USDC stablecoin released its reserves report as of July 31, 2022.
                                ...
                                <h3 className="text-teal-100 text-xl m-6">How Many USD Coins (USDC) Are There in Circulation?</h3>
                                <p class="text-white px-1 md:px-15">It’s a bit difficult to give an exact number here — as in theory, the number of USDC that can exist is limitless. New coins are created in line with demand, whenever someone wants to purchase one with their humble dollar.
