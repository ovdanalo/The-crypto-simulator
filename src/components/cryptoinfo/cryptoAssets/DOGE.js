                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p className="text-white px-20">In 2014, a not-for-profit foundation was formed by members of the Dogecoin team to provide support, advocacy, trademark protection and governance for the cryptocurrency project. However, the foundation was dissolved over time.
                                ...
                                <p className="text-white px-20">Weeks after the release of Dogecoin Core version 1.14.6, core developer Michi Lumin announced the launch of Libdogecoin, a C-library of the network’s building blocks.
                                ...
                                <p className="text-white px-20">Due to its low transaction fees and constant patronage from Elon Musk, a number of traditional companies have moved to make Dogecoin a payment option.
