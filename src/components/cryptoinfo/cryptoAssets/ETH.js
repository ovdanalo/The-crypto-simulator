                    ...
                    return (
                        <div>
                            ...
                            <div>
                                ...
                                <p className="text-white px-20">Ethereum is a decentralized open-source blockchain system that features its own cryptocurrency, Ether. ETH works as a platform for numerous other cryptocurrencies, as well as for the execution of decentralized smart contracts.
                                ...
                                <p className="text-white px-20">Ethereum has a total of eight co-founders — an unusually large number for a crypto project. They first met on June 7, 2014, in Zug, Switzerland.
                                ...
                                <p className="text-white px-20">Ethereum has pioneered the concept of a blockchain smart contract platform. Smart contracts are computer programs that automatically execute the actions necessary to fulfill an agreement between several parties on the internet. They were designed to reduce the need for trusted intermediates between contractors, thus reducing transaction costs while also increasing transaction reliability.
                                ...
                                <p className="text-white px-20">Ethereum Name Service, aka ENS, is a distributed and extensible naming system based on the Ethereum blockchain. It is essentially the Web3 version of DNS, short for domain name service.
                                ...
                                <p className="text-white px-20">The Ethereum network has been plagued with high transaction fees, often spiking at seasons of high demand. In May 2021, the average transaction fee of the network peaked at $71.72.
                                ...
                                <p className="text-white px-20">The EIP-1559 upgrade introduces a mechanism that changes the way gas fees are estimated on the Ethereum blockchain. Before the upgrade, users had to participate in an open auction for their transactions to be picked up by a miner. This process is known as a “first-price auction,” and as expected, the highest bidder wins.
                                ...
                                <p className="text-white px-20">In 2022, Ethereum renamed its transition from proof-of-work to proof-of-stake from Ethereum 2.0 to The Merge. The Merge is scheduled to go ahead on Sept. 15, 2022, with the merge of the Goerli testnet successfully completed on Aug. 11, 2022.
