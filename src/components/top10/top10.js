...
const Top10 = (props) => {
  ...
  return (
    <div
      className={`flex flex-col mx-auto w-full lg:max-w-4xl xl:max-w-5xl my-8 lg:rounded-2xl sm:max-md:text-xs ${isDarkTheme ? "bg-black-200" : "bg-white-mode-200"} `}
    >
      <div className={` w-full lg:w-11/12 mx-auto lg:rounded-lg my-4 p-2 ${isDarkTheme ? "bg-black-100" : "bg-white-mode-300"}`}>
