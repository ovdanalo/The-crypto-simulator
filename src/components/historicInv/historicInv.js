    ...
    return (
        <div className='flex flex-col xl:flex-row bg-black-200 lg:w-10/12 xl:w-8/12 h-def mx-auto my-6 justify-center rounded-lg'>
            ...
            <div className='flex flex-col bg-black-100 h-def w-11/12 xl:w-2/3 m-6 xl:mx-6 mx-auto rounded-lg'>
                {hasData ?
                    <div>
                        <h3 className='text-teal-100 text-3xl text mt-4 text-center'>RESULT</h3>
                        ...
                        <div className='p-4'>
                            <div className='border-2 border-black-300 bg-black-200 pt-2 mx-auto rounded-lg shadow w-4/5'>
                                <h3 className='text-white text-2xl mb-2 text-center'>Initial amount : <span className='text-teal-100 m-4'>{amount} €</span></h3>
                            </div>
                            <div className='border-2 border-black-300 bg-black-200 pt-2 mx-auto rounded-lg shadow w-4/5'>
                                <h3 className='text-white text-2xl mb-2 text-center'>Crypto amount : {returnData.percentage > 0
                            ...
                            <div className='flex flex-col justify-center items-center mx-auto'>
                                <div className='mx-auto border-black-300 bg-black-200 pt-2 px-6 border-2 rounded-lg shadow w-4/5'>
                                    <h3 className='text-white text-2xl mb-4 text-center'>End amount:
                                ...
                                <div className='mx-auto border-black-300 bg-black-200 pt-2 px-6 border-2 rounded-lg shadow w-4/5'>
                                    <h3 className='text-white text-2xl mb-4 text-center'>Percentage difference: {returnData.percentage > 0
