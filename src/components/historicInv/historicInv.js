...
const Historic = (props) => {
    ...
    return (
        <div className={`flex flex-col xl:flex-row  lg:w-10/12 xl:w-8/12 h-def mx-auto my-6 justify-center rounded-lg ${isDarkTheme ? "bg-black-200" : "bg-white-mode-200"}`}>
            <div className={`flex flex-col h-def mx-auto w-11/12 xl:w-1/3 xl:m-6 xl:mr-0 rounded-lg mt-12 py-12 ${isDarkTheme ? "bg-black-100" : "bg-white-mode-300"}`}>
                <form>
                    <div>
                    ...
                    <label htmlFor='crypto' className={`flex pt-6 pb-6 justify-center ${isDarkTheme ? "text-white" : "text-black-100"}`}>In which cryptocurrency?</label>
                            ...
                            <input list="cryptoList" id="selectCrypto" name="crypto"  onChange={evt => setEndCurrency(evt.target.value)} className={`shadow rounded-lg p-1 text-center  ${isDarkTheme ? "bg-teal-50" : "bg-white-mode-100"}`} />
                        </div>
                    </div>
            ...
            <div className={`flex flex-col h-def w-11/12 xl:w-2/3 m-6 xl:mx-6 mx-auto rounded-lg ${isDarkTheme ? "bg-black-100" : "bg-white-mode-300"}`}>
                {hasData ? <div>
                    <div className='flex justify-center'>
                    ...
                    <div className='p-4'>
                        <div className={`border-2 mb-2 pt-2 mx-auto rounded-lg shadow w-4/5 ${isDarkTheme ? "bg-black-200 border-black-300" : "bg-white-mode-300 border-black-100"}`}>
                            <h3 className={` text-2xl mb-1 ${isDarkTheme ? "text-white" : "text-black-100"}`}>Initial amount : <span className={` m-4 ${isDarkTheme ? "text-green-100 green-shadow" : "text-green-100 "}`}>{amount} €</span></h3>
                        </div>
                        <div className={`border-2 mb-1 pt-2 mx-auto rounded-lg shadow w-4/5 ${isDarkTheme ? "bg-black-200 border-black-300" : "bg-white-mode-300 border-black-100"}`}>
                            <h3 className={` text-2xl mb-2 ${isDarkTheme ? "text-white" : "text-black-100"}`}>Crypto amount : {returnData.percentage > 0
                        ...
                        <div className='flex flex-col justify-center items-center mx-auto'>
                            <div className={`mx-auto mb-1 pt-2 px-6 border-2 rounded-lg shadow w-4/5 ${isDarkTheme ? "bg-black-200 border-black-300" : "bg-white-mode-300 border-black-100"}`}>
                                <h3 className={` text-2xl mb-4 ${isDarkTheme ? "text-white" : "text-black-100"}`}>End amount:
                            ...
                            <div className={`'mx-auto pt-2 px-6 border-2 rounded-lg shadow w-4/5 ${isDarkTheme ? "bg-black-200 border-black-300" : "bg-white-mode-300 border-black-100"}`}>
                                <h3 className={` text-2xl mb-4 ${isDarkTheme ? "text-white" : "text-black-100"}`}>Percentage difference: {returnData.percentage > 0
